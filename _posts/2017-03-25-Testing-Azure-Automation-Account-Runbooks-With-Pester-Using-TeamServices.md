...
'TODO: Tarun to insert screen shot'  
...
'TODO: Tarun to add a link to the marketplace'

Configure the extension to the folder that contains the unit tests...  

'TODO: Tarun to add a screen shot'  
...
'TODO: Tarun to add link to GitVersion MarketPlace'
...
'TODO: Screen shot of the test results outcome '